namespace BudgetPlaner.Sdk.Constants;
...
public static class ApiEndpoints
{
    ...
    public static class Categories
    {
        ...
        public const string Restore = $"{Base}/{{id}}";       // PATCH  /api/categories/{id}
    }
    ...
    public static class Currencies
    {
        ...
        public const string Restore = $"{Base}/{{id}}";       // PATCH  /api/currencies/{id}
    }
